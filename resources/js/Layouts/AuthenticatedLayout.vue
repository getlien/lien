...
<template>
    <div class="flex min-h-screen bg-zinc-950">
        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4">
                ...
                <div v-if="sidebar.length && isCollapsed" class="mt-6 space-y-2">
                    <Link
                        ...
                        :key="org.id"
                        :href="org.repositories.length ? `/repos/${org.repositories[0].id}/dashboard` : '/dashboard'"
            ...
            <div v-if="!isCollapsed" class="border-t border-zinc-800 px-4 py-2">
                ...
                >
                    ...
                    <span>Search...</span>
                    <kbd class="ml-auto rounded border border-zinc-700 px-1.5 py-0.5 font-mono text-[10px] text-zinc-500">⌘K</kbd>
                </button>
            </div>
        ...
        <!-- Main area -->
        <div :class="['flex min-h-screen min-w-0 flex-1 flex-col transition-all duration-200', isCollapsed ? 'lg:pl-16' : 'lg:pl-64']">
            <!-- Mobile top bar -->
            <div class="sticky top-0 z-30 flex h-14 items-center gap-4 border-b border-zinc-800 bg-zinc-950/80 px-4 backdrop-blur lg:hidden">
                <button
                    type="button"
