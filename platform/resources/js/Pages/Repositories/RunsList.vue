...
function loadMoreGroups() {
  ...
  router.get(
    `/repos/${props.repository.id}/runs`,
    { view: 'grouped', page: nextPage },
    { preserveState: true },
  );
}
</script>
  ...
  <AuthenticatedLayout>
    <div>
      ...
      <div class="mt-6 flex items-center gap-4">
        <div
          class="flex items-center gap-1 rounded-lg border border-zinc-800 bg-zinc-900 p-1"
          role="tablist"
      ...
      <div
        v-if="view === 'all'"
        class="mt-4 overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900"
      >
        <div class="overflow-x-auto">
          <table class="w-full divide-y divide-zinc-800" aria-label="Review runs">
            <thead>
              <tr>
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-zinc-400">
                  Run
                </th>
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-zinc-400">
                  Type
                ...
                <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-zinc-400">
                  Files
                </th>
                <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-zinc-400">
                  Duration
            ...
            <tbody class="divide-y divide-zinc-800">
              ...
              >
                ...
                <td
                  class="whitespace-nowrap px-6 py-4 text-right text-sm text-zinc-400"
                  :title="formatFullDate(run.created_at)"
                >
            ...
            <tbody class="divide-y divide-zinc-800">
              ...
              <tr v-if="!prGroups?.data?.length">
                <td colspan="7" class="px-6 py-8 text-center text-sm text-zinc-400">
                  ...
                  <p class="mt-2">
                    No PR runs yet. Open a pull request to trigger your first review.
                  </p>
                </td>
              </tr>
            </tbody>
      ...
      <!-- Pagination: All Runs -->
      <div
        v-if="view === 'all' && runs?.last_page > 1"
