            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-zinc-400">
                        ...
                        &middot; {{ totalRuns }} total runs
                    </p>
                </div>
            </div>

            <div v-if="baselineProgress?.is_generating" class="mt-8 rounded-lg border border-brand-500/20 bg-brand-950 p-5">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-zinc-400">
                            {{ baselineProgress.completed }} of {{ baselineProgress.total }} baseline analyses complete.
                            Charts and insights will appear as results come in.
                        </p>
                    </div>
                </div>
            ...
            <Deferred :data="['trendData', 'topFunctions']">
                ...
                <div class="mt-8 grid gap-6 deferred-enter 3xl:grid-cols-2">
                    <div>
                        ...
                        <div v-else-if="!baselineProgress?.is_generating" class="rounded-lg border border-zinc-800 bg-zinc-900 p-12 text-center">
                            ...
                            <p class="mt-3 text-sm text-zinc-400">Open a pull request to trigger your first review, or check back after baselines complete.</p>
                        </div>
                    </div>

                    <TopFunctionsTable :functions="topFunctions" :cluster-map-data="clusterMapData" @select="selectedFunction = $event" />
                </div>
            </Deferred>
