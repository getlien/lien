  ...
  for (const org of sidebar.value) {
    for (const repo of org.repositories) {
      items.push(
        ...
        { label: `${repo.full_name} › Findings`, url: `/repos/${repo.id}/findings` },
    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- Footer -->
          <div
            class="flex items-center gap-4 border-t border-zinc-800 px-4 py-2 text-xs text-zinc-400"
          >
