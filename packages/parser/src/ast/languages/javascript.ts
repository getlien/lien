...
/**
 * Complexity configuration shared by JavaScript and TypeScript.
 *
 * Both language definitions reference this single object (mirroring how the
 * TypeScript extractor classes above extend their JavaScript bases), so tuning
 * JS/TS complexity only requires one edit. Consumers only read from it.
 */
export const jsTsComplexityConfig: LanguageDefinition['complexity'] = {
  decisionPoints: [
    'if_statement',
    'while_statement',
    'for_statement',
