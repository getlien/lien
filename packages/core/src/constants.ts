...
// Configuration version - this is the default for new configs
// When CLI uses core, it will override with its own package version
export const CURRENT_CONFIG_VERSION = '0.1.0';
