...
`CLAUDE.md`'s "Package Structure" section is the canonical, actively-maintained map of `packages/parser`, `packages/cli`, `packages/parser-native`, and `packages/site`. Read it there rather than here.
